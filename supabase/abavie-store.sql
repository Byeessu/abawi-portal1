...
-- ── DATA DE DÉMO (optionnel) ─────────────────────────────
-- INSERT INTO abavie_suppliers (nom, contact_nom, telephone, ville, verified) VALUES
--   ('MediSénégal SA', 'Amadou Diop', '77 123 45 67', 'Dakar', true),
--   ('GlobalMed Fournitures', 'Fatou Ndiaye', '76 987 65 43', 'Thiès', true);
